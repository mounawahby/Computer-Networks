...
myinfo = ["B","10.0.100.3","08:00:27:58:32:0d", port]


othersPorts = [8000,8002,8003]
    ...
    while temp:
       ...
       if not data:
            ...
            if mac != 0: #then we already have the mac address so no need to send a broadcast message
                ...
                targetport = getportfromIP(targetIP)# met le vrai port de la table add function getportbyid only change info(0]
       ...
       elif data=='pingmac 08:00:27:58:32:0d':
